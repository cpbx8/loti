...
export default function MealTimeline({ entries }: Props) {
            ...
            return (
              <div key={entry.id} className="relative">
                ...
                <button
                  ...
                  className={`w-full text-left surface-card rounded-xl px-4 py-3 ${borderClass} hover:shadow-md transition-shadow`}
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {/* Chevron → detail */}
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-text-tertiary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
